...
reactDom 的 child 属性是标签包含住的东西-可以是文字或是子标签 const hText =
React.createElement('span', {}, 'Hello','World') 等价于
React.createElement('span', {child:['Hello','World']}) 定义 class 时使用的属性是
className
